function getRandomUser() {
    ...
    xhttp.onreadystatechange = function() {
     ...
     eladdress.innerHTML = data.results[0].location.street.name + " , " + data.results[0].location.city + ","+  data.results[0].location.postcode + "," + data.results[0].location.state +", " + data.results[0].location.country;
